...
export function FAQHero() {
  return (
    <div className="max-w-[700px] mb-12 text-left select-none animate-fade-in">
      <span className="font-mono text-xs tracking-[0.2em] text-accent-gold uppercase mb-4 block">
        FAQ
      </span>
