...
/**
 * Framework Library — Decision Funnel. Ported from the
 * /design-lab/research-frameworks prototype, replacing the Research page's
 * previous numbered-list treatment.
 *
 * The five frameworks are a pipeline where each stage's output is the next
 * stage's input, narrowing from the whole market down to an actual trade
 * (frameworkLibrary's own file comment calls this out explicitly). This
 * makes that narrowing the visual subject instead of stating it in prose.
 *
 ...
 * helper the rest of the site uses. Nothing here is invented copy.
 *
 * id="framework-library" / scroll-mt-24 are load-bearing: the hero's
 * "Exhibit 01 · Current issue" card and the page's contents rail both
 * target this anchor.
 */
