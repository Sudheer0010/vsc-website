...
export function ExecutionFramework() {
  ...
  return (
    <SectionContainer id="vsc-vs-funds" className="py-28 md:py-36 select-none bg-transparent">
      <div className="max-w-[1050px] mx-auto bg-[#FFFFFF] border border-rule rounded-2xl p-8 sm:p-12 text-left">
        ...
        <div className="mb-14">
          ...
          <p className="font-mono text-xs sm:text-sm text-ink-soft leading-relaxed max-w-[620px]">
        ...
        <div className="w-full overflow-x-auto scrollbar-hide">
          <table className="w-full min-w-[700px] border-collapse text-left">
            <thead>
              <tr className="border-b border-rule pb-4">
                <th className="font-mono text-xs text-ink-faint uppercase tracking-widest pb-4 w-[25%] font-bold">Feature</th>
                <th className="font-mono text-xs text-ink-faint uppercase tracking-widest pb-4 w-[37.5%] font-bold">Traditional Mutual Funds</th>
            ...
            <tbody className="divide-y divide-rule">
              {comparisons.map((row, idx) => (
                <tr key={idx} className="hover:bg-canvas-sunk transition-colors duration-150">
                  {/* Feature Parameter */}
                  ...
                  {/* Mutual Funds */}
                  <td className="py-5 pr-4 font-mono text-xs sm:text-sm text-ink-muted leading-relaxed">
                    {row.mutualFunds}
                  </td>
                  
                  {/* VSC Capital */}
                  <td className="py-5 font-mono text-xs sm:text-sm text-ink leading-relaxed font-medium">
                    {row.vsc}
                  </td>
                </tr>
              ))}
