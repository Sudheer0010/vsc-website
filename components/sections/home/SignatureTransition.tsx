...
export function SignatureTransition() {
  return (
    <section className="relative w-full py-28 md:py-36 bg-[#060810] border-y border-white/[0.02] overflow-hidden select-none z-10 flex items-center justify-center">
      <div className="container max-w-[1000px] text-center px-6">
        ...
        <h2 className="relative font-display text-2xl sm:text-3xl md:text-4xl leading-[1.4] text-white font-light tracking-tight max-w-[750px] mx-auto">
