      ...
      >
        ...
        >
          ...
          <button 
            ...
            className="btn btn-gold w-full mt-6 py-3.5 text-xs font-mono tracking-wider uppercase inline-flex items-center justify-center gap-2"
          >
            {isSubmitting && (
              <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
